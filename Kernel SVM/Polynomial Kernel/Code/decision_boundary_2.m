...
[a_2,b_2] = kernel_svm_model(X_train_full,y_train_full,0.1,2);
classified_xy = kernel_classifier(X_train_full, y_train_full, xy, a_2, b_2, 0.1, 2);
idx = classified_xy > 0;
test_X = X_test_full;
test_y = y_test_full;
...
% store the figure
saveas(gcf, 'decision_boundary_2.png');
hold off;
