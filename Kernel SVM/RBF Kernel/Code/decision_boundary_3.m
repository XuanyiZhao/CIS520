...
% idx = probability>0.5;
%-----------------------------------
[a_3,b_3] = RBF_kernel_svm_model(X_train_full, y_train_full, 0.1, 0.1);
classified_xy = RBF_kernel_classifier(X_train_full, y_train_full, xy, a_3, b_3, 0.1, 0.1);
idx = classified_xy > 0;
test_X = X_test_full;
test_y = y_test_full;
...
% store the figure
saveas(gcf, 'decision_boundary_3.png');
hold off;
