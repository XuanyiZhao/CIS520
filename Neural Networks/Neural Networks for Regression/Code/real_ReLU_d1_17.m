...
init_b1 = load('../Data-set-2/InitParams/17/b1.txt');
init_b2 = load('../Data-set-2/InitParams/17/b2.txt');
init_w1 = load('../Data-set-2/InitParams/17/W1.txt');
init_w2 = load('../Data-set-2/InitParams/17/W2.txt');

tic
[w1_2,w2_2, b1_2, b2_2] = NN_ReLU_model(X_train_full,y_train_full, ...
    init_w1, init_w2, init_b1, init_b2, 20000, 3.5*10^-6);
